...
import { MessageSquare, CalendarDays, FlaskConical, BookOpen } from 'lucide-react'
    ...
    <div className="min-h-full bg-gray-50">
      ...
      <section className="py-3 px-4 bg-gradient-to-r from-blue-50 to-violet-50 border-b border-blue-100">
        <div className="max-w-6xl mx-auto flex items-center gap-4 flex-wrap">
          ...
          <Link
            href="/citations"
            className="flex items-center gap-2 px-3 py-2 bg-white border border-indigo-200 rounded-lg hover:border-indigo-400 hover:shadow-sm transition-all"
          >
            <BookOpen className="w-4 h-4 text-indigo-600" />
            <div>
              <div className="text-xs font-semibold text-gray-900">文献引用</div>
              <div className="text-[10px] text-gray-500">SCI 论文收录</div>
            </div>
          </Link>
        </div>
      </section>
